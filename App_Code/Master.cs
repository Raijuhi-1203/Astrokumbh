...
public class Master
{
    ...
    public int Insert_Enquiry(string name, string mobileno, string message, string create_date, string create_time)
    {
        con.Close();
        con.Open();
        int RowsAffected = 0;
        try
        {
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = con;
            cmd.CommandText = "insert into [digit196_furniture_mart].[enquiry](name,mobileno,message,create_date,create_time) values (@name,@mobileno,@message,@create_date,@create_time) ";
            cmd.CommandType = CommandType.Text;
    ...
    public int Add_Product(string name,string price, string offer_price, string src)
    {
        con.Close();
        con.Open();
        int RowsAffected = 0;
        try
        {
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = con;
            cmd.CommandText = "insert into product(name,price,offer_price,src) values (@name,@price,@offer_price,@src) ";
            cmd.CommandType = CommandType.Text;
            cmd.Parameters.AddWithValue("@name", name);
    ...
    public int Add_Video(string src)
    {
        con.Close();
        con.Open();
        int RowsAffected = 0;
        try
        {
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = con;
            cmd.CommandText = "insert into video(src) values (@src) ";
            cmd.CommandType = CommandType.Text;
            cmd.Parameters.AddWithValue("@src", src);
