<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="manage-product.aspx.cs" Inherits="admin_manage_product" %>
        ...
        <div class="container-fluid">
            ...
            <div class="card card-danger">
                <div class="card-header">
                    ...
                    <a class="btn btn-success" href="add-product.aspx" style="float: right;">Add Product</a>
                </div>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Price">
                                            <ItemTemplate>
                                                 ...
                                                 <asp:Label ID="txt_mrp" runat="server" Text='<%# Eval("price") %>'></asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="Offer Price">
                                            <ItemTemplate>
                                                 ...
                                                 <asp:Label ID="txt_omrp" runat="server" Text='<%# Eval("offer_price") %>'></asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="Photo">
                                            <ItemTemplate>
                                                ...
                                                <img src='<%# Eval("src") %>' style="width:100px;height:auto;" />
