<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="add-video.aspx.cs" Inherits="admin_add_video" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="exampleInputPassword1">Video Link<span style="color: red">&nbsp;*</span> </label>
