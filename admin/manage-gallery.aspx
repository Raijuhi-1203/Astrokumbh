<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="manage-gallery.aspx.cs" Inherits="admin_manage_gallery" %>
        ...
        <div class="container-fluid">
            ...
            <div class="card card-danger">
                <div class="card-header">
                    ...
                    <a class="btn btn-success" href="add-gallery.aspx" style="float: right;">Add Gallery</a>
                </div>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Name">
                                            <ItemTemplate>
                                                ...
                                                <img src='<%# Eval("url") %>' style="width:100px;height:auto;" />
