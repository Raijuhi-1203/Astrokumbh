    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="small-box " style="background: #2dce89 !important;">
                        <div class="inner">
                            <h3>
                                <asp:Label ID="lblphotos" runat="server" ForeColor="White" Text="0"></asp:Label>
                            </h3>
                            <p style="color: white">Total Photos</p>
                        </div>
                        <div class="icon">
